...
trait Sqarray
{
    ...
    public $table2 = [//ZB_ZFPZNR_Y
                ...
                'SJWH'        =>  "'_'",    //        可查
                'BJWH'        =>  "'_'",    //       不十分确定
                'YWLXDM'      =>  "'_'",    //       查询zbs 确定全是'_'  
                'XMFLDM'      =>  "'_'",    //      查询zbs 确定全是'_'
    ...
    public $table3 = [//ZB_ZFPZNR_Y_MC
                ...
                'ZFFSMC'       =>  "'授权支付'",
                'MXZBWH'       =>  "'~~~~公共文号~~~~'",       //  可查
                'MXZBXH'       =>  "~~~~MXZBXH~~~~",             //    可查zhibiao
                'ZBLYMC'       =>  "'~~~~其他指标~~~~'",       //  可查
                'ZJXZMC'       =>  "'~~~~其他资金~~~~'",       //  可查
                'YSKMMC'       =>  "'~~~~其他支出~~~~'",       //  可查
                'YSKMQC'       =>  "'~~~~其他支出-其他支出-其他支出~~~~'",  //可查zhibiao        
                'JFLXMC'       =>  "'~~~~其他商品和服务支出~~~~'",  //  可查
